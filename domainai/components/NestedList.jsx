...
export default function NestedList({
  ...
  const handleModalClose = (e,buttonState) => {
    if (buttonState === "Save") {
  ...
  return (
    <>
      <Dialog
        ...
        open={modalOpen}
        scroll="paper"
        onClose={(e) => handleModalClose(e, "Cancel")}
      ...
      >
        ...
        <Toolbar sx={{ justifyContent: "flex-end" }}>
          <Button
            sx={{ fontFamily: "poppins" }}
            variant="contained"
            onClick={(e) => handleModalClose(e, "Save")}
          >
            Save
          </Button>
          <Button
      ...
      >
        <ListSubheader
          sx={{ fontFamily: "poppins", marginTop: 4 }}
          component="div"
              ...
              <List component="div" disablePadding>
                {group.entries.map((entry, entryIndex) => (
                  <React.Fragment key={entryIndex}>
                    <ListItemButton
                      onClick={() => handleClick(entry.entryPoint)}
                    >
                      <ListItemIcon>
                        {open[entry.entryPoint] ? (
                          <ChevronLeft />
                        ) : (
                          <ChevronRight />
                        )}
                      ...
                      <List component="div" disablePadding>
                        {entry.questions.map((question, questionIndex) => (
                          <ListItemButton
                            key={questionIndex}
                            onClick={() =>
                              handleQuestionClick(entry.entryPoint, question)
                            }
                          >
                            <ListItemIcon>
                              <ChatIcon />
